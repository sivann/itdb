...
<div id="tabs">
    ...
    <tr>
      <td class="tdtop">
        <table class="tbl2" style='width:300px;'>
          <tr>
            <td colspan=2><h3>Software Properties</h3></td>
          </tr>
          <tr>
            <td class="tdt">ID :</td>
          ...
          <tr>
            ...
            <td title='Add more manufacturers at the "Agents" menu'>
          ...
          <tr>
            ...
            <td><input  validate='required:true' class='input2 mandatory' size=20 type=text name='stitle' value="<?php echo $stitle?>"></td>
          </tr>
          <tr>
            <td class="tdt"><?php te("Version ");?>:</td>
            <td><input validate='required:true' class='input2 mandatory' size=20 type=text name='sversion' value="<?php echo $sversion?>"></td>
          </tr>
          <tr>
            <td class="tdt"><?php te("Purchase Date");?>* :</td>
            <td><input class='dateinp mandatory' validate='required:true' size=10 id='purchdate' title='<?php echo $datetitle?>' type=text name='purchdate' value='<?php echo $d?>'></td>
          </tr>
          <tr>
            <td class="tdt"><?php te("Quantity ");?>:</td>
            <td><?php echo $qtsel?> </td>
          </tr>
            <?php 
              //licensetype
              $t0="";$t1="";$t2="";
          ...
          <tr>
            <td class="tdt"><?php te("Licencing Info ");?>:</td>
            <td colspan=2>
              <textarea name='slicenseinfo' class='tarea2' wrap='soft'><?php echo $slicenseinfo?></textarea>
            </td>
          </tr>
          <tr>
            <td class="tdt"><?php te("Other Info ");?>:</td>
            <td colspan=2> <textarea name='sinfo' class='tarea2' wrap='soft'><?php echo $sinfo?></textarea></td>
          </tr>
        </table>
      </td>
  ...
  <div id='tab2' class='tab_content'>
    <tr>
      <td colspan=3>
        <h2><?php te("Installed Into");?><sup>1</sup>
      ...
      <td colspan=3 class='tdc' >
        ...
        <div style='margin-left:auto;margin-right:auto;' class='scrltblcontainer2'>
          <table width='100%' class='brdr sortable' id='itemslisttbl'>
            <thead>
              <tr>
                <th width='5%'><?php te("Installed");?></th>
            ...
            <tbody>
              <?php 
                while ($ir=$sth->fetch(PDO::FETCH_ASSOC)) {
                  ...
                  echo $ir['id'];
                  echo "</div></a></td>".
                  "<td $cls>".$typeid2name[$ir['itemtypeid']]."&nbsp;</td>".
...
<table>
  <tr>
    <td colspan=2>
      <button type="submit"><img src="images/save.png" alt="Save"><?php te("Save");?></button></td>
  <?php 
