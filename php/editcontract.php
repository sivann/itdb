...
<div id="tabs">
      ...
      <tr>
        <td class="tdtop">
          ...
          <table border=0 class="tbl2" width='100%'>
            <tr>
              <td class="tdt">ID :</td> <td><input  class='input1' type=text name='id' value='<?php echo $id?>' readonly size=3></td>
            </tr>
            <tr>
              <td class="tdt"><?php te("Title");?> :</td>
              <td><input  class='input1 mandatory' validate='required:true' size=20 type=text name='title' value="<?php echo $r["title"]?>"></td>
            </tr>
            <tr>
              <td class="tdt"><?php te("Number");?> :</td>
              <td><input  class='input1 mandatory' validate='required:true' size=20 type=text name='number' value="<?php echo $r["number"]?>"></td>
            </tr>
            <tr>
              <td class="tdt"><?php te("Type");?> :</td>
              <td>
            ...
            <tr>
              <td class="tdt"><?php te("Total Cost");?> (<?php echo $settings['currency']?>) :</td>
              <td><input  class='input1' size=20 type=text name='totalcost' value="<?php echo $r["totalcost"]?>"></td>
            </tr>
            <tr>
              <?php  
                $sdate=strlen($r["startdate"])?date($dateparam,$r['startdate']):"";
              ?>
              <td class="tdt"><?php te("Start Date");?> :</td>
              <td><input  class='dateinp mandatory' id=startdate validate="required:true " size=10 title='<?php echo $datetitle?>' type=text id='startdate' name='startdate' value='<?php echo $sdate?>'> <!-- id is for validation to work with date selectors -->
              </td>
            </tr>
            <tr>
              <?php  
              ...
              ?>
              <td class="tdt"><?php te("Current EndDate");?> :</td>
              <td><input class='dateinp mandatory' validate='required:true' size=10 title='<?php echo $datetitle?>' type=text id='currentenddate' name='currentenddate' value='<?php echo $edate?>'>
              </td>
            </tr>
          </table>
        </td>
          ...
          <div class="scrltblcontainer3">
            <table class=tbl2 id="renewalstable">
              ...
              <tr> 
                ...
                <td><input class='dateinp' style='width:9em' type="text" name="ren_enddatebefore[]" size="8" value='<?php echo $enddatebefore?>' ></td>
                <td><input class='dateinp' style='width:9em' type="text" name="ren_enddateafter[]" size="8" value='<?php echo $enddateafter?>' ></td>
                <td><input class='dateinp' style='width:9em' type="text" name="ren_effectivedate[]" size="8" value='<?php echo $effectivedate?>' ></td>
                <td><input type=text  name="ren_notes[]" style='width:25em;' value='<?php echo $notes?>'></td> 
                <td><input class='dateinp' style='width:9em' type="text" name="ren_dateentered[]" size="8" value='<?php echo $dateentered?>'></td>
                <td><input style='width:8em' type="text" name="ren_enteredby[]" size="8" value='<?php echo $enteredby?>'></td> 
              </tr> 
              <?php 
              }
              ?>
  ...
  <div id="tab4" class="tab_content"> <!-- software rel -->
    ...
    ?>
    <div style='margin-left:auto;margin-right:auto;' class='scrltblcontainer2'>
      <table width='100%' class='brdr sortable'  id='softlisttbl'>
        <thead>
  ...
  <div id="tab5" class="tab_content"> <!-- invoices rel -->
    ...
    ?>
    <div style='margin-left:auto;margin-right:auto;' class='scrltblcontainer2'>
      <table width='100%' class='brdr sortable'  id='invlisttbl'>
        <thead>
          <tr>
            <th width='5%'><?php te("Associated");?></th>
            <th><?php te("ID");?></th>
  ...
  <div id="ev_dialog" title="Edit Event" method="post" style='display:none'>
    ...
    <form name="evteditfrm" method="post" id="evteditfrm" action="php/contractevents.php">
      <table>
        ...
        <tr>
          <td><?php te("Event Start");?></td>
          <td><input type=text class='dateinp' name='ev_startdate'></td>
        </tr>
        <tr>
          <td><?php te("Event End");?></td>
          <td><input type=text class='dateinp' name='ev_enddate'></td>
        </tr>
        <tr>
          <td><?php te("Description");?></td>
          <td><textarea name='ev_description' ></textarea></td>
        </tr>
      </table>
