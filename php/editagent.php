...
<table >
    ...
    <td class="tdtop">
      ...
      <table border=0 class="tbl2" width='100%'>
        <tr>
          ...
          <td><input class='input1' type=text name='id' value='<?php echo $id?>' readonly size=3></td>
        </tr>
        <tr>
          <td class="tdt"><?php te("Name");?> :</td>
          <td><input class='input1 mandatory' size=20 type=text name='title' value="<?php echo $title?>"></td>
        </tr>
        <tr>
          <td class="tdt"><?php te("Type(s)");?> :</td> 
  ...
  <tr> 
    ...
    <td>
      <h3><?php te("Contacts");?><img id='caddrow' src='images/add.png' title="<?php te("Add Row");?>"></h3>
