...
<div id="tabs">
  ...
  <?php   if (is_numeric($buyerid))
    echo "<a title='edit buyer (agent)' href='$scriptname?action=editagent&amp;id=$buyerid'><img src='images/edit.png'></a> "; ?>
      ...
      <tr>
	  <td class="tdt"><?php te("Date");?>*:</td> <td><input  class='dateinp mandatory' validate='required:true,date:true' size=10 id='date' title='<?php echo $datetitle?>' type=text name='date' value='<?php echo $d?>'>
	  </td>
      </tr>
...
<div id="tab5" class="tab_content">
      ...
      <iframe class="upload_frame" name="upload_frame" 
	    src="php/uploadframe.php?id=<?php echo $id?>&amp;types=3&amp;assoctable=invoice2file&amp;colname=invoiceid&amp;defdate=<?php echo urlencode($d)?>"  
