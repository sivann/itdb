...
<div id="tabs">
      ...
      <tr>
        <td class='tdtop'>
          <table border='0' class=tbl2>
            <tr>
              <td colspan=2><h3><?php te("Intrinsic Properties");?></h3></td>
            </tr>
            ...
            <tr>
              <td class='tdt'>
                ...
                <?php te("Manufacture");?><sup class='red'>* </sup>:
              </td>
            ...
            <tr>
              <td class='tdt'><?php te("Model");?><sup class='red'>* </sup>:</td>
              <td><input type=text validate='required:true' class='mandatory' value="<?php echo $model?>" name='model'></td>
            </tr>
            ...
            <tr>
              <td class='tdt'><?php te("S/N");?> :</td><td><input type=text value='<?php echo $sn?>' name='sn'></td>
            </tr>
            <tr>
              <td class='tdt'><?php te("S/N 2");?> :</td>
              <td><input type=text value='<?php echo $sn2?>' name='sn2'></td>
            </tr>
            <tr>
              <?php 
                //dell service tag
              ...
              ?>
              <td class='tdt'><?php echo $st?></td>
              <td><input type=text value='<?php echo $sn3?>' name='sn3'></td>
            </tr>

            <tr>
              <td class='tdt'><?php te("Comments");?> :</td>
              <td><textarea wrap='soft' class=tarea1  name='comments'><?php echo $comments?></textarea></td>
            </tr>
            <tr>
              <td class='tdt'><?php te("Label");?> :</td>
              <td title='<?php te("show also this text on printable labels");?>'><input type='text' value="<?php echo $label?>" name='label'></td>
            </tr>
          </table>
        </td>
        ...
        <td class='tdtop'>
          <table border='0' class=tbl2><!-- Usage -->
            <tr>
              <td colspan=2 ><h3><?php te("Usage");?></h3></td>
            </tr>
            ...
            <tr>
              <td class='tdt'><?php te("User");?><sup class='red'>* </sup>:</td>
              <td title='<?php te("User responsible for this item");?>'>
            ...
            <tr>
              <?php 
                //rackposition
              ?>
              <td class='tdt' class='tdt'><?php te("Rack Pos. (topmost) ");?>:</td>
              <td>
            ...
            <tr>
              <td class='tdt'><?php te("Maintenance Instructions ");?>:</td>
              <td title='<?php te("Special maintenance instructions");?>'>
              <textarea wrap='soft' class=tarea1 name='maintenanceinfo'><?php echo $maintenanceinfo?></textarea></td>
            </tr>

            <tr>
              <td colspan=2 style='padding-top:10px'><h3><?php te("Accounting");?></h3></td>
            </tr>
            <tr>
              <td class='tdt'><?php te("Shop/Origin ");?>:</td>
              <td title='<?php te("e.g. like donator, etc. Vendor info is best to be provided in the related invoice");?>'><input size=15 value='<?php echo $origin?>' name='origin'></td>
            </tr>
            <tr>
              <td class='tdt'><?php te("Purchace Price (");?><?php echo $settings['currency']?>) :</td>
              <td><input size=15 value='<?php echo $purchprice?>' name='purchprice'></td>
            </tr>
        ...
        <td class='tdtop'>
          <table border='0' class=tbl2> <!-- 2-Warranty & Support -->
            <tr>
              <td colspan=2><h3><?php te("Warranty");?></h3></td>
            </tr>
            <tr>
            <td class='tdt'><?php te("Date of Purchase ");?>:</td>
            <td>
              <input type=text class='dateinp' title='<?php echo $datetitle?>' size=12 id=aa0 value='<?php echo $d?>' name='purchasedate'>
            </td>
            </tr>
            <tr>
              <td class='tdt'><?php te("Warranty&nbsp;Months ");?>:</td>
              <td><input type=text size=15 value='<?php echo $warrantymonths?>' name='warrantymonths'></td>
            </tr>
            <tr>
              <td class="tdt"><?php te("Warranty Info ");?>:</td>
              <td><input  size=12 type=text name='warrinfo' value="<?php echo $warrinfo?>"></td>
            </tr>
            <tr>
            <tr>
              <td colspan=2 style='padding-top:10px'><h3>Misc</h3></td>
            </tr>
            <tr>
              <td class='tdt'><?php te("HDs (TB) ");?>:</td>
              <td title='Comma separated. E.g. Enter "2, 0.6" for 1x2T+1x600G'><input type=text size=15 value='<?php echo $hd?>' name='hd'></td>
            </tr>
            <tr>
              <td class='tdt' class='tdt'><?php te("RAM (GB) ");?>:</td>
              <td><input type=text size=15 value='<?php echo $ram?>' name='ram'></td>
            </tr>
            <tr>
              <td class='tdt' class='tdt'><?php te("CPU Model ");?>:</td>
              <td title='e.g. Intel E5450'><input type=text size=15 value='<?php echo $cpu?>' name='cpu'></td>
            </tr>

            <tr>
              <td class='tdt' class='tdt' title='Number of installed CPUs (used for licensing)'><?php te("# CPUs ");?>:</td>
            ...
            <tr>
              <td class='tdt' class='tdt' title='<?php te("Cores per CPU (used for licensing)");?>'><?php te("Cores/CPU ");?>:</td>
        ...
        <td class='tdtop'>
          <table border='0' class=tbl2> <!-- 3-Network -->
            <tr>
              <td colspan=2 ><h3><?php te("Network");?></h3></td>
            </tr>
            <tr>
              <td class='tdt'><?php te("DNS Name ");?>:</td>
              <td><input type=text size=15 value='<?php echo $dnsname?>' name='dnsname'></td>
            </tr>
            ...
            <tr>
              <td class='tdt'>Rem.Adm.IP :</td>
              <td title='<?php te("Remote Administration IP");?>'><input type=text size=15 value='<?php echo $remadmip?>' name='remadmip'></td>
            </tr>
            <tr>
              <td class='tdt'><?php te("Ptch.PnlPr t ");?>:</td>
              <td title='<?php te("Patch Panel Port ");?>'><input type=text size=15 value='<?php echo $panelport?>' name='panelport'></td>
            </tr>
            <tr>
              <td class='tdt' class='tdt'><?php te("Switch ");?>:</td>
              <td title='<?php te("populated from items of type switch or router");?>' >
            ...
            <tr>
              <td class='tdt'><?php te("Switch Port ");?>:</td>
              <td><input type=text size=15 value='<?php echo $switchport?>' name='switchport'></td>
            </tr>
            <tr>
      ...
      <tr>
        ...
        <td class='tdtop' colspan=2>
          <table cellspacing='0' cellpadding='0' width='100%'>
            <tr>
              <td>
                <h3><?php te("Associated Files");?><img onclick='window.location.href=window.location.href;' 
                    src='images/refresh.png'></h3>
              </td>
            </tr>
            <tr>
              <td>&nbsp; <!-- file links -->
  ...
  <div id='tab2' class='tab_content'><!-- Associations -->
    <table class='tbl' style='width:100%;border-bottom:1px solid #cecece'><!-- connect to other items -->
      <tr>
        <td colspan=2 title='Add hierarchical or sibling relations to: parts, cards, monitors, et.c.'>
          <h2>Connected To<sup>1</sup>
  ...
  <div id='tab3' class='tab_content'><!-- Invoices -->
    <!-- invoice links -->
    <table class=tbl style='border-bottom:1px solid #cecece;width:100%;'>
      <tr>
      ...
      <tr>
        <td colspan=2>
          <div class='scrltblcontainer'>
            <table id='invoicelisttbl' width='100%' class='brdr sortable'>
              <thead>
                <tr>
                  <th><?php te("Rel");?></th>
                  <th><?php te("ID");?></th>
  ...
  <div id='tab5' class='tab_content'>
    ...
    <div style='margin-left:auto;margin-right:auto;' class='scrltblcontainer2'>
      <table width='100%' class='brdr sortable' id='softwarelisttbl'>
        <thead>
          <tr>
  ...
  <div id='tab6' class='tab_content'>
    ...
    ?>
    <div style='margin-left:auto;margin-right:auto;' class='scrltblcontainer2'>
      <table width='100%' class='brdr sortable'  id='contrlisttbl'>
        <thead>
          <tr>
            <th width='5%'><?php te("Associated");?></th>
            <th><?php te("ID");?></th>
