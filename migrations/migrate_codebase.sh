...
# This script updates all PHP and Twig files to use the new normalized column names
...
find src/ templates/ -type f \( -name "*.php" -o -name "*.twig" \) -exec cp --parents {} "$BACKUP_DIR/" \;
...
replace_in_files() {
    ...
    find src/ templates/ -type f -name "$file_pattern" -exec sed -i "s/$pattern/$replacement/g" {} +
}
...
replace_in_files " sn " " serial_number " "*.php"
replace_in_files "\.sn," ".serial_number," "*.php"
replace_in_files "\.sn2" ".serial_number_2" "*.php"
replace_in_files "\.sn3" ".serial_number_3" "*.php"
...
replace_in_files " userid" " user_id" "*.php"
replace_in_files "\.ipv4" ".ipv4_address" "*.php"
replace_in_files " ipv4" " ipv4_address" "*.php"
replace_in_files "\.ipv6" ".ipv6_address" "*.php"
replace_in_files " ipv6" " ipv6_address" "*.php"
replace_in_files "\.usize" ".rack_units" "*.php"
replace_in_files " usize" " rack_units" "*.php"
replace_in_files "\.rackmountable" ".is_rack_mountable" "*.php"
replace_in_files " rackmountable" " is_rack_mountable" "*.php"
replace_in_files "\.macs" ".mac_addresses" "*.php"
replace_in_files " macs" " mac_addresses" "*.php"
replace_in_files "\.remadmip" ".remote_admin_ip" "*.php"
replace_in_files " remadmip" " remote_admin_ip" "*.php"
replace_in_files "\.panelport" ".panel_port" "*.php"
replace_in_files " panelport" " panel_port" "*.php"
replace_in_files "\.ports" ".port_count" "*.php"
replace_in_files " ports " " port_count " "*.php"
...
replace_in_files " status " " status_id " "*.php"
...
replace_in_files " locareaid" " location_area_id" "*.php"
replace_in_files "\.coa" ".certificate_of_authenticity" "*.php"
...
replace_in_files "\.depth" ".depth_mm" "*.php"
replace_in_files " depth " " depth_mm " "*.php"
...
echo "  rm -rf src/ templates/"
echo "  cp -r $BACKUP_DIR/src $BACKUP_DIR/templates ."
