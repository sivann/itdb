...
if (isset($_GET['export']) && $_GET['export']==1) {
  ...
  header('Content-Disposition: attachment; filename = "itdb '.date("Y-m-d").'.xls"');
...
$thead= "\n<tr><th title='Search'>".
     ...
     "<th title='Warranty expiration in '><a href='$fscriptname?action=$action&amp;orderby=remdays$ob'>Warr. Left</a></th>".
