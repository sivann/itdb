...
<table style='width:100%' border=0>
    ...
    <td class="tdtop">
      <table class="tbl2" style='width:300px;'>
        ...
        <tr>
          ...
          <td><input class='input2 mandatory' validate='required:true' size=20 type=text name='title' value="<?php echo $r['title']?>"></td>
        </tr>
        <tr>
          <td class="tdt"><?php te("Issue Date");?> :</td>
          <td><input class='input2 dateinp mandatory' validate='required:true' id='date' size=20 type=text name='date' 
            value="<?php if (!empty($r['date'])) echo date($dateparam,$r['date'])?>"></td>
        </tr>
        <tr>
          <td class="tdt"><?php te("Filename");?> :</td>
          <td><a target=_blank href="<?php echo $uploaddirwww.$r['fname'] ?>"><?php echo $r['fname']?></a></td>
        </tr>
        <tr>
          <td title='Number of items/software/invoices/etc which reference this file'
                class="tdt"><?php te("Associations");?> :</td>
          <td><b><?php if ($_GET['id']!="new") echo countfileidlinks($_GET['id'],$dbh);?></b></td>
        </tr>
        <tr>
          <td class="tdt"><?php te("Uploaded by");?> :</td>
          <td><?php echo $r['uploader']?> on <?php if (!empty($r['uploaddate'])) echo date($dateparam." H:m",$r['uploaddate'])?></td>
        </tr>
      ...
      <div id="tabs">
        ...
        <div id="tab1" class="tab_content"><!-- item associations -->
          ...
          <table border='0' class=tbl2 style='width:100%;border-bottom:1px solid #cecece'><!-- connect to other items -->
            <tr>
              <td colspan=2 ><?php te("Associate file with the following items");?>:
        ...
        <div id="tab2" class="tab_content"><!-- software associations -->
          ...
          <table border='0' class=tbl2 style='width:100%;border-bottom:1px solid #cecece'><!-- connect to software -->
            <tr>
              <td colspan=2 >Associate file with the following software:
        ...
        <div id="tab3" class="tab_content"><!-- contracts associations -->
          ...
          <table border='0' class=tbl2 style='width:100%;border-bottom:1px solid #cecece'><!-- connect to contracts -->
            <tr>
              <td colspan=2><?php te("Associate file with the following contracts");?>:
  ...
  <tr>
    <td colspan=1><button type="submit"><img src="images/save.png" alt="Save"><?php te("Save");?></button></td>
