...
<table border="0" width="100%"><!-- Main tables -->
  <tr>
    <td class="tdtop" width=20%>
      <table class="tbl2" style='width:300px;'>
        ...
        <tr>
          <td class="tdt"><?php te("Height (U) ");?>:</td>
          <td>
        ...
        <tr>
          <td class="tdt"><?php te("Numbering ");?>:</td>
          <td>
            <select name='revnums'>
              <?php
                if ($r['revnums']==1) {
        ...
        <tr>
          ...
          <td><input class='input2 mandatory' validate='required:true' size=20 type=text name='label' value="<?php echo $r['label']?>"></td>
        </tr>
        <tr>
          <td class="tdt"><?php te("Depth");?>(mm) :</td> 
          <td><input class='input2 mandatory' validate='required:true' size=20 type=text name='depth' value="<?php echo $r['depth']?>"></td>
        </tr>
        <tr>
          <td class="tdt"><?php te("Model ");?>:</td> 
          <td><input class='input2 mandatory' size=20 type=text name='model' value="<?php echo $r['model']?>"></td>
        </tr>
        <tr>
          <td class="tdt"><?php te("Comments ");?>:</td> 
          <td><textarea class='tarea1' wrap=soft name=comments><?php echo $r['comments']?></textarea></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td title='<?php echo $occupation?> U occupied'>
            <div style='width:150px;border:1px solid #888;padding:0;'>
              <div style='background-color:#8ECE03;width:<?php echo $width?>px'>&nbsp;</div>
            </div>
          </td>
        </tr>
      </table>
