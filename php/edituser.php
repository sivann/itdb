    ...
    <td class="tdtop" width=20%>
      <table class="tbl2" style='width:300px;'>
        ...
        <tr>
          ...
          value='<?php echo $id?>' readonly size=3><?php echo $id?></td>
        </tr>
        <tr>
          <td class="tdt"><?php te("Username");?> :</td>
          <td><input class='input2 mandatory' validate='required:true' size=20 type=text name='username' value="<?php echo $r['username']?>"></td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="tdt"><?php te("User Description");?> :</td> 
          <td><input autocomplete="off" class='input2' size=20 
            type=text name='userdesc' value="<?php echo $r['userdesc']?>"></td>
        </tr>
        <tr>
          <td class="tdt"><?php te("Password");?> :</td> 
        ...
        <tr>
          ...
          <td><?php echo countitemsofuser($r['id']) ?></td>
        </tr>
      </table>
      <ul>
