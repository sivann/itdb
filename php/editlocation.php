...
<table style='width:100%' border=0>
  <tr>
    <td class="tdtop" style='width:35em;'>
      <table class="tbl2" style='width:360px;'>
        <tr>
          <td colspan=2><h3><?php te("Location Properties");?></h3></td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="tdt"><?php te("Building Name ");?>:</td>
          <td><input class='input2 mandatory' size=20 type=text name='name' value="<?php echo $r['name']?>"></td>
        </tr>
        <tr>
          <td class="tdt"><?php te("Floor ");?>:</td>
          <td><input class='input2 mandatory' size=20 type=text name='floor' value="<?php echo $r['floor']?>"></td>
        </tr>
        <tr>
        ...
        <tr>
          <td title="Number of items/software/invoices/etc which reference this file" 
              class="tdt"><?php te("Associations (items/racks) ");?>:</td>
          <td><b><?php if ($_GET['id']!="new") echo countloclinks($_GET['id'],$dbh);?></b></td>
        </tr>
      </table>
