...
<h1>
  <?php te("Software");?>
  <a title='<?php te("Add new software");?>' href='<?php echo $scriptname?>?action=editsoftware&amp;id=new'><img border=0 src='images/add.png'></a>
</h1>

<div class='container'>
  <table  class="display nowrap" id="softlisttbl" width="100%">
    <thead>
      <tr>
        <th nowrap><?php te("ID");?></th>
        <th><?php te("Manufacturer");?></th>
        <th><?php te("Title");?></th>
        <th><?php te("Version");?></th>
        <th><?php te("Purchase Date");?></th>
        <th title='<?php te("maintenance end date");?>'><?php te("Maint. End");?></th>
        <th><?php te("License Info");?></th>
        <th><?php te("Other Info");?></th>
        <th><?php te("Tags");?></th>
        <th><?php te("QTY");?></th>
    ...
    <tbody>
      ...
      <tr>
        <td>
          <div class='editid'>
            <a title='<?php te("Edit Software");?>' href='<?php echo $scriptname?>?action=editsoftware&amp;id=<?php echo $r['id']?>'><?php echo $id?></a>
          </div>
        </td>
