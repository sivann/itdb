...
<h1>
  <?php te("Agents");?>
  <a title='<?php te("Add new Agent");?>' href='<?php echo $scriptname?>?action=editagent&amp;id=new'><img border=0 src='images/add.png' ></a>
</h1>

<div class='container'>
  <table class='display nowrap' width='100%' id='agentlisttbl'>
    <thead>
      <tr>
