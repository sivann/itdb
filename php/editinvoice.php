...
<div id="tabs">
      ...
      <tr>
        <td class="tdtop">
          <table class="tbl2" width='100%'>
            <tr>
              <td colspan=2>
                <h3><?php te("Invoice Properties");?></h3>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td class="tdt">
                ...
                <?php te("Vendor");?><sup class='red'>* </sup>:
              </td>
              <td>
            ...
            <tr>
              <td class="tdt">
                ...
                <?php te("Buyer");?><sup class='red'>* </sup>:
              </td>
              <td>
            ...
            <tr><td class="tdt"><?php te("Order Num");?><sup class='red'>* </sup>:</td>
            ...
            <tr>
              ...
              <td><input class='dateinp mandatory' validate='required:true' size=10 id='date' title='<?php echo $datetitle?>' type=text name='date' value='<?php echo $d?>'></td>
            </tr>
            <tr>
  ...
  <div id="tab5" class="tab_content">
    <table class="tbl2" width='100%'>
      <tr>
        <td colspan=2><h2><?php te("Upload a File");?></h2></td>
      </tr>
      <tr>
        <td colspan=2 style='text-align:center'><?php te("suggested resolution: 1024 pixels for A4 scans");?></td>
      </tr>
        <!-- file upload -->
        <tr>
          <td class="tdc">
